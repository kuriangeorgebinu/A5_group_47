...
public class OrderSpecificCommandUtils implements CommandUtils{
    ...
    public String makeOrder(String makeOrderCommand, List<Store> storeList, List<Customer> customerList) {
    ...
    public String displayOrders(String displayOrderCommand, List<Store> stores) {
        ...
        if (!storeNames.contains(storeName)) {
            ...
            for (Order order : orderList) {
                ...
                outputList.add("orderID:" + order.getOrderIdentifier());
                    ...
                    for (LineItem lineItem : lineItems) {
                        if (!(lineItem.getItem() == null)) {
                            ...
                            if (!(item == null)) {
                                ...
                                outputList.add("item_name:" + item.getItemName() + ",total_quantity:" + lineItem.getQuantity() + ",total_cost:" + (int) totalCost(lineItem.getUnitPrice(), lineItem.getQuantity()) + ",total_weight:" + (int) totalWeight(item.getWeight(), lineItem.getQuantity()));
                            }
                        }
                    }
                }
    ...
    public String executePurchaseOrder(String puchaseOrderCommand, List<Store> storeList) {
        ...
        if (!(storeNames.contains(storeName))) {
            ...
            if (!(orderList.contains(orderIdentifier))) {
                ...
                if (!droneList.isEmpty()) {
                    ...
                    return drone.executeOrder(order);
                }
                return "";
            }
        }
    ...
    public String executeCancelOrder(String cancelOrderCommand, List<Store> storeList) {
        ...
        if (!storenames.contains(storeName)) {
            ...
            if (!orderIds.contains(orderIdentifier)) {
                System.out.println("ERROR:order_identifier_does_not_exist");
                return "ERROR:order_identifier_does_not_exist"; 
            }
            else {
    ...
    public String requestItemToOrder(String requestOrderCommand, List<Store> listOfStores) {
        ...
        if (!storeNames.contains(storeName)) {
            ...
            if(!orderIdentifiers.contains(orderIdentifier)) {
                System.out.println("ERROR:order_identifier_does_not_exist");
                return "ERROR:order_identifier_does_not_exist"; 
            }
            else {
