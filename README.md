...
### To zip your code
You should validate your zip file has everything needed. Your src folder & everything under your src folder. Nothing else should be in your zip file. < filename > should be replaced with 2022-06-A3 
#### Mac / Linux
```
...
[Link To Ed Discussion](https://edstem.org/us/courses/22421/discussion/1574054)
